    ...
    $.jgrid = $.jgrid || {}, $.jgrid.hasOwnProperty("defaults") || ($.jgrid.defaults = {}), $.extend($.jgrid, {
        ...
        clearBeforeUnload: function (a) {
            ...
            if (c.grid) {
                ...
                var
                    d, e = b.headers.length, f = ["formatCol", "sortData", "updatepager", "refreshIndex", "setHeadCheckBox", "constructTr", "formatter", "addXmlData", "addJSONData", "grid", "p"];
                ...
                for (e = f.length, d = 0; e > d; d++)c.hasOwnProperty(f[d]) && (c[f[d]] = null, delete
                    c[f[d]])
            }
        },
            ...
            if (!this.grid) {
                ...
                var
                    x, y = ["shiftKey", "altKey", "ctrlKey"], z = function (a, b) {
                        ...
                        var
                            g = '<input role="checkbox" type="checkbox" id="jqg_' + d.p.id + "_" + a + '" ' + f + ' name="jqg_' + d.p.id + "_" + a + '"' + (e ? 'checked="checked"' : "") + "/>", h = A(b, c, "", null, a, !0);
                        ...
                        if ("local" === m.datatype && p.repeatitems === !0)for (j = H(s), k = G("local"), e = m.keyIndex === !1 ? $.isFunction(p.id) ? p.id.call(d, n) : p.id : m.keyIndex, a = 0; o > a; a++) {
                            for (c = n[a], f = $.jgrid.getAccessor(c, e), void
                                ...
                                0 !== g[e] ? g[e] : f, g = null))), i = {}, i[p.id] = f, r && (c = $.jgrid.getAccessor(c, r) || c), l = $.isArray(c) ? j : k, b = 0; b < l.length; b++)h = $.jgrid.getAccessor(c, l[b]), i[q[b + s].name] = h;
                            $.extend(!0, n[a], i)
                        }
                    }, K = function () {
                        var
                        ...
                        if (g && (d.p.data = [], d.p._index = {}, d.p.localReader.id = h), d.p.reccount = 0, $.isXMLDoc(a)) {
                            ...
                            if (d.p.gridview === !0 && (n = d.p.treeANode > -1 ? d.p.treeANode : 0, d.p.grouping ? g || (w.jqGrid("groupingRender", S, d.p.colModel.length, d.p.page, T), S = null) : d.p.treeGrid === !0 && n > 0 ? $(d.rows[n]).after(K.join("")) : (V.append(K.join("")), d.grid.cols = d.rows[0].cells)), d.p.totaltime = new
                                        Date - f, K = null, d.p.subGrid === !0)try {
                        ...
                        if (a) {
                            ...
                            if (d.p.gridview === !0 && (w = d.p.treeANode > -1 ? d.p.treeANode : 0, d.p.grouping ? j || (A.jqGrid("groupingRender", _, d.p.colModel.length, d.p.page, V), _ = null) : d.p.treeGrid === !0 && w > 0 ? $(d.rows[w]).after(Q.join("")) : (ba.append(Q.join("")), d.grid.cols = d.rows[0].cells)), d.p.totaltime = new
                                        Date - f, Q = null, d.p.subGrid === !0)try {
                        ...
                        var
                            b, c, e, f, g = d.p.multiSort ? [] : "", h = [], i = !1, j = {}, k = [], l = [];
                        if ($.isArray(d.p.data)) {
                            var
                                m, n, o, p = d.p.grouping ? d.p.groupingView : !1;
                            if ($.each(d.p.colModel, function () {
                                    if (c = this.sorttype || "text", o = this.index || this.name, "date" === c || "datetime" === c ? (this.formatter && "string" == typeof
                                ...
                                }), d.p.multiSort && (g = t, h = u), d.p.treeGrid && d.p._sort)return void
                                $(d).jqGrid("SortTree", g, d.p.sortorder, j[g].stype || "text", j[g].srcfmt || "");
                            var
                                q = {
                                    eq: function (a) {
                                        return a.equals
                            ...
                            if (d.p.ignoreCase && (r = r.ignoreCase()), d.p.search === !0) {
                                ...
                                d.p.treeGrid && "nested" === d.p.treeGridModel && r.orderBy(d.p.treeReader.left_field, "asc", "integer", "", null);
                            ...
                            var
                                w = r.select(), x = parseInt(d.p.rowNum, 10), y = w.length, z = parseInt(d.p.page, 10), A = Math.ceil(y / x), B = {};
                            if ((d.p.search || d.p.resetsearch) && d.p.grouping && d.p.groupingView._locgr) {
                                ...
                                if (d.p.footerrow && d.p.userDataOnFooter) {
                                    for (D
                                        in
                                        d.p.userData)d.p.userData.hasOwnProperty(D) && (d.p.userData[D] = 0);
                                    E = !0
                                }
                                for (C = 0; y > C; C++) {
                                    if (E)for (D
                                        in
                                        d.p.userData)d.p.userData.hasOwnProperty(D) && (d.p.userData[D] += parseFloat(w[C][D] || 0));
                                    F.call($(d), w[C], C, x)
                                }
                            }
                        ...
                        if (d.p.colModel[b].sortable && !(d.p.savedRow.length > 0)) {
                            if (c || (d.p.lastsort === b && "" !== d.p.sortname ? "asc" === d.p.sortorder ? d.p.sortorder = "desc" : "desc" === d.p.sortorder && (d.p.sortorder = "asc") : d.p.sortorder = d.p.colModel[b].firstsortorder || "asc", d.p.page = 1), d.p.multiSort)V(b, f, e); else {
                                if (e) {
                        ...
                        for (var
                            e
                            in
                            d.p.colFilters)if (d.p.colFilters.hasOwnProperty(e)) {
                            var
                                f = d.p.colFilters[e];
                        ...
                        var
                            e, f, g = $(".ui-jqgrid-view").css("font-size") || "11px", h = '<ul id="column_menu" class="ui-search-menu modal-content column-menu" role="menu" tabindex="0" style="font-size:' + g + ";left:" + b + "px;top:" + c + 'px;">', i = d.p.colModel[a], j = $.extend({
                                sorting: !0,
                                columns: !0,
                                filtering: !0,
                                seraching: !0,
                                grouping: !0,
                                freeze: !0
                            }, i.coloptions), k = $.jgrid.getRegional(d, "colmenu");
                ...
                var
                    Da = $("<table " + k(l, "headerTable", !1, "ui-jqgrid-htable ui-common-table") + " style='width:" + d.p.tblwidth + "px' role='presentation' aria-labelledby='gbox_" + this.id + "'></table>").append(ra), Ea = d.p.caption && d.p.hiddengrid === !0 ? !0 : !1, Fa = $("<div class='ui-jqgrid-hbox" + ("rtl" === h ? "-rtl" : "") + "'></div>"), Ga = "Bootstrap" === d.p.styleUI ? 2 : 0;
                ra = null, e.hDiv = document.createElement("div"), e.hDiv.style.width = e.width - Ga + "px", e.hDiv.className = k(l, "headerDiv", !0, "ui-jqgrid-hdiv"), $(e.hDiv).append(Fa), $(Fa).append(Da), Da = null, Ea && $(e.hDiv).hide(), d.p.pager && ("string" == typeof
                    d.p.pager ? "#" !== d.p.pager.substr(0, 1) && (d.p.pager = "#" + d.p.pager) : d.p.pager = "#" + $(d.p.pager).attr("id"), $(d.p.pager).css({width: e.width + "px"}).addClass(k(l, "pagerBox", !0, "ui-jqgrid-pager")).appendTo(w), Ea && $(d.p.pager).hide(), U(d.p.pager, "")), d.p.cellEdit === !1 && d.p.hoverrows === !0 && $(d).bind("mouseover", function (a) {
                ...
                $(d).before(e.hDiv).click(function (a) {
                    ...
                    if ("A" !== ma.tagName && ("INPUT" !== ma.tagName && "TEXTAREA" !== ma.tagName && "OPTION" !== ma.tagName && "SELECT" !== ma.tagName || b))if (Ha = na[0].id, ma = $(ma).closest("tr.jqgrow>td"), ma.length > 0 && (Ia = $.jgrid.getCellIndex(ma), Ja = $(ma).closest("td,th").html(), $(d).triggerHandler("jqGridCellSelect", [Ha, Ia, Ja, a]), $.isFunction(d.p.onCellSelect) && d.p.onCellSelect.call(d, Ha, Ia, Ja, a)), d.p.cellEdit !== !0) {
                        if (c)if (d.p.multikey)a[d.p.multikey] ? $(d).jqGrid("setSelection", Ha, !0, a) : d.p.multiselect && b && (b = $("#jqg_" + $.jgrid.jqID(d.p.id) + "_" + Ha).is(":checked"), $("#jqg_" + $.jgrid.jqID(d.p.id) + "_" + Ha)[d.p.useProp ? "prop" : "attr"]("checked", !b)); else if (d.p.multiselect && d.p.multiboxonly)if (b)$(d).jqGrid("setSelection", Ha, !0, a); else {
                            var
                    ...
                    } else if (d.p.multiselect && b && c)$(d).jqGrid("setSelection", Ha, !0, a); else if (ma.length > 0)try {
                ...
                if ($(e.hDiv).after(e.bDiv).mousemove(function (a) {
                    ...
                    }), "rtl" === d.p.direction && $(d).bind("jqGridAfterGridComplete.setRTLPadding", function () {
                        var
        ...
        getGridParam: function (a, b) {
            ...
            return this.each(function () {
                ...
                d(a) {
                    var
                        b = $(l.grid.bDiv)[0].clientHeight, c = $(l.grid.bDiv)[0].scrollTop, d = $(l.rows[a]).position().top, e = l.rows[a].clientHeight;
            ...
            return this.each(function () {
                var
                    h, i, j = this;
                if (null == a)f = !0, c = [], d = j.rows.length - 1; else {
                ...
                for (b && b === !0 && j.p.data.length > 0 || (b = !1); d > g;)f && (i = j.rows[g]), $(i).hasClass("jqgrow") && (b ? e = j.p.data[j.p._index[i.id]] : $('td[role="gridcell"]', i).each(function (a) {
                    if (h = j.p.colModel[a].name, "cb" !== h && "subgrid" !== h && "rn" !== h)if (j.p.treeGrid === !0 && h === j.p.ExpandColumn)e[h] = $.jgrid.htmlDecode($("span:first", this).html()); else
                        try {
            ...
            d(a) {
                ...
                for (b
                    in
                    a)if (a.hasOwnProperty(b))return !1;
                return !0
            }
            ...
            return this.each(function () {
                ...
                if (d.grid && (isNaN(b) ? $(d.p.colModel).each(function (a) {
                        return this.name === b ? (e = a, !1) : void
                            0
                    }) : e = parseInt(b, 10), e >= 0)) {
                    var
                        f = $(d).jqGrid("getGridRowById", a);
                    if (f)try {
            ...
            return this.each(function () {
                ...
                if (b.grid) {
                    if ("boolean" != typeof
                            a && (a = !1), b.p.deepempty)$("#" + $.jgrid.jqID(b.p.id) + " tbody:first tr:gt(0)").remove(); else {
                        var
    ...
    a.fmatter = {}, a.extend(a.fmatter, {
        ...
        if (void
            ...
            if (i && (j = b.split(","), j = a.map(j, function (b) {
                ...
                for (k = 0; k < l.length; k++)if (h = l[k].split(d), h.length > 2 && (h[1] = a.map(h, function (a, b) {
                        return b > 0 ? a : void
                            0
                    }).join(d)), i)a.inArray(h[0], j) > -1 && (g[m] = h[1], m++); else if (a.trim(h[0]) === a.trim(b)) {
                    g[0] = h[1];
                    break
                }
            } else
        ...
        var
            d, e = {
                ...
                delbutton: !0,
                editformbutton: !1
            }, f = c.rowId, g = "", h = a.jgrid.getRegional(this, "nav"), i = a.jgrid.styleUI[c.styleUI || "jQueryUI"].fmatter, j = a.jgrid.styleUI[c.styleUI || "jQueryUI"].common;
        if (void
        ...
        if (void
                0 !== k && a.isFunction(k))f = k.call(this, a(b).text(), c, b); else if (void
        ...
        if (h.value) {
            ...
            if (m && (n = g.split(","), n = a.map(n, function (b) {
                ...
                for (o = 0; o < p.length; o++)if (k = p[o].split(i), k.length > 2 && (k[1] = a.map(k, function (a, b) {
                        return b > 0 ? a : void
                            0
                    }).join(i)), m)a.inArray(a.trim(k[1]), n) > -1 && (f[q] = k[0], q++); else if (a.trim(k[1]) === a.trim(g)) {
                    f[0] = k[0];
                    break
                }
    ...
    a.extend(a.jgrid, {
        showModal: function (a) {
            ...
            if (a.offsetParent)do
                b += a.offsetLeft, c += a.offsetTop; while (a = a.offsetParent);
            return [b, c]
            ...
            if (d.resize)if (a.fn.jqResize)a(m).append("<div class='jqResize " + k.resizable + " " + l.icon_base + " " + k.icon_resizable + "'></div>"), a("#" + a.jgrid.jqID(b.themodal)).jqResize(".jqResize", b.scrollelm ? "#" + a.jgrid.jqID(b.scrollelm) : !1); else
                try {
            ...
            if (c = a.extend({
                    ...
                    c.focusField || c.focusField ? c.focusField = 0 : c.focusField = !1, a.fn.jqm && c.jqm === !0)c.jqM ? a(b).attr("aria-hidden", "false").jqm(c).jqmShow() : a(b).attr("aria-hidden", "false").jqmShow(); else if ("" !== c.gbox && (a(".jqgrid-overlay:first", c.gbox).show(), a(b).data("gbox", c.gbox)), a(b).show().attr("aria-hidden", "false"), c.focusField >= 0)try {
            ...
            a.isFunction(c.dataInit) && c.dataInit.call(d, b, c), c.dataEvents && a.each(c.dataEvents, function () {
                void
                    0 !== this.data ? a(b).bind(this.type, this.data, this.fn) : a(b).bind(this.type, this.fn)
            })
        ...
        editGridRow: function (c, d) {
            ...
            return d = a.extend(!0, {
                    ...
                    a(A).find(".FormElement").each(function () {
                        ...
                        if (c.length) {
                            ...
                            switch (a(this).get(0).type) {
                                case"checkbox":
                                    if (a(this).is(":checked"))u[this.name] = a(this).val(); else {
                                        var
                ...
                f(c, d, e, f) {
                    ...
                    if ("_empty" !== c && (r = a(d).jqGrid("getInd", c)), a(d.p.colModel).each(function (n) {
                            if (h = this.name, i = this.editrules && this.editrules.edithidden === !0 ? !1 : this.hidden === !0 ? !0 : !1, l = i ? "style='display:none'" : "", "cb" !== h && "subgrid" !== h && this.editable === !0 && "rn" !== h) {
                                if (r === !1)k = ""; else if (h === d.p.ExpandColumn && d.p.treeGrid === !0)k = a("td[role='gridcell']:eq(" + n + ")", d.rows[r]).text(); else {
                                    try {
                                ...
                                var
                                    v = a.extend({}, this.editoptions || {}, {
                                        ...
                                        rowabove: !1,
                                        rowcontent: ""
                                    }, this.formoptions || {}), x = parseInt(w.rowpos, 10) || p + 1, z = parseInt(2 * (parseInt(w.colpos, 10) || 1), 10);
                ...
                i(c, d, e) {
                    ...
                    n && (a('td[role="gridcell"]', n).each(function (h) {
                        if (f = m[h].name, "cb" !== f && "subgrid" !== f && "rn" !== f && m[h].editable === !0) {
                            if (f === d.p.ExpandColumn && d.p.treeGrid === !0)g = a(this).text(); else
                                try {
                ...
                k() {
                    ...
                    for (g
                        in
                        u)if (u.hasOwnProperty(g) && (n = a.jgrid.checkValues.call(s, u[g], g), n[0] === !1))break;
                    if (j(), n[0] && (o = a(s).triggerHandler("jqGridAddEditClickSubmit", [b[s.p.id], u, w]), void
                        ...
                        if (b[s.p.id].processing = !0, a("#sData", A + "_2").addClass(h.active), m = b[s.p.id].url || a(s).jqGrid("getGridParam", "editurl"), f = p.oper, e = "clientArray" === m ? s.p.keyName : p.id, u[f] = "_empty" === a.trim(u[s.p.id + "_id"]) ? p.addoper : p.editoper, u[f] !== p.addoper ? u[e] = u[s.p.id + "_id"] : void
                            ...
                            for (l
                                in
                                s.p.treeReader)if (s.p.treeReader.hasOwnProperty(l)) {
                                var
                                    t = s.p.treeReader[l];
                            ...
                            v = a.extend({
                                ...
                                complete: function (g, j) {
                                    ...
                                    if (a("#sData", A + "_2").removeClass(h.active), u[e] = s.p.idPrefix + u[e], g.status >= 300 && 304 !== g.status ? (n[0] = !1, n[1] = a(s).triggerHandler("jqGridAddEditErrorTextFormat", [g, w]), a.isFunction(b[s.p.id].errorTextFormat) ? n[1] = b[s.p.id].errorTextFormat.call(s, g, w) : n[1] = j + " Status: '" + g.statusText + "'. Error code: " + g.status) : (n = a(s).triggerHandler("jqGridAddEditAfterSubmit", [g, u, w]), void
                                            0 === n && (n = [!0, "", ""]), n[0] && a.isFunction(b[s.p.id].afterSubmit) && (n = b[s.p.id].afterSubmit.call(s, g, u, w))), n[0] === !1)a(".FormError", y).html(n[1]), a(".FormError", y).show(); else if (s.p.autoencode && a.each(u, function (b, c) {
                                            u[b] = a.jgrid.htmlDecode(c)
                                        }), u[f] === p.addoper ? (n[2] || (n[2] = a.jgrid.randId()), null == u[e] || "_empty" === u[e] ? u[e] = n[2] : n[2] = u[e], b[s.p.id].reloadAfterSubmit ? a(s).trigger("reloadGrid") : s.p.treeGrid === !0 ? a(s).jqGrid("addChildNode", n[2], k, u) : a(s).jqGrid("addRowData", n[2], u, d.addedrow), b[s.p.id].closeAfterAdd ? (s.p.treeGrid !== !0 && a(s).jqGrid("setSelection", n[2]), a.jgrid.hideModal("#" + a.jgrid.jqID(B.themodal), {
                                        ...
                                        }, 500)), (b[s.p.id].checkOnSubmit || b[s.p.id].checkOnUpdate) && (a(y).data("disabled", !1), "_empty" !== s.p.savedData[s.p.id + "_id"]))for (l
                                        in
                ...
                l(b, c) {
                    var
                        d, e = !1;
                    if (e = !(a.isPlainObject(b) && a.isPlainObject(c) && Object.getOwnPropertyNames(b).length === Object.getOwnPropertyNames(c).length), !e)for (d
                        in
                        c)if (c.hasOwnProperty(d)) {
                    ...
                    if (b[s.p.id].checkOnSubmit || b[s.p.id].checkOnUpdate) {
                        ...
                        c = a.map(s.p.savedData, function (a, b) {
                            ...
                            if (-1 === c.indexOf(this.name)) {
                                ...
                                if ("checkbox" === e)a(this).is(":checked") || (b = a(this).attr("offval")); else if ("select-multiple" === e)b = b.join(","); else if ("radio" === e) {
                                    if (d.hasOwnProperty(this.name))return !0;
                                    d[this.name] = void
                                        0 === a(this).attr("offval") ? "off" : a(this).attr("offval")
                                }
                ...
                if (s.grid && c) {
                    s.p.savedData = {};
                    var
                        t, u, v, w, x = s.p.id, y = "FrmGrid_" + x, z = "TblGrid_" + x, A = "#" + a.jgrid.jqID(z), B = {
                            themodal: "editmod" + x,
                            modalhead: "edithd" + x,
                            modalcontent: "editcnt" + x,
                            scrollelm: y
                        }, C = !0, D = 1, E = 0, F = "string" == typeof
                    ...
                    if (F ? (I = q(b[a(this)[0].p.id].template), t = A) : (I = a("<table id='" + z + "' class='EditTable ui-common-table'><tbody></tbody></table>"), t = A + "_2"), y = "#" + a.jgrid.jqID(y), a(L).append("<div class='FormError " + h.error + "' style='display:none;'></div>"), a(L).append("<div class='tinfo topinfo'>" + b[s.p.id].topinfo + "</div>"), a(s.p.colModel).each(function () {
                        ...
                        if (F ? (a(L).find("#pData").replaceWith(P), a(L).find("#nData").replaceWith(Q), a(L).find("#sData").replaceWith(R), a(L).find("#cData").replaceWith(S), W = a("<div id=" + z + "></div>").append(L)) : W = a("<div></div>").append(L).append(T), a(L).append("<div class='binfo topinfo bottominfo'>" + b[s.p.id].bottominfo + "</div>"), a.jgrid.createModal(B, W, b[a(this)[0].p.id], "#gview_" + a.jgrid.jqID(s.p.id), a("#gbox_" + a.jgrid.jqID(s.p.id))[0]), M && (a("#pData, #nData", A + "_2").css("float", "right"), a(".EditButton", A + "_2").css("text-align", "left")), b[s.p.id].topinfo && a(".tinfo", y).show(), b[s.p.id].bottominfo && a(".binfo", y).show(), W = null, T = null, a("#" + a.jgrid.jqID(B.themodal)).keydown(function (c) {
                            ...
                            }), d.checkOnUpdate && (a("a.ui-jqdialog-titlebar-close span", "#" + a.jgrid.jqID(B.themodal)).removeClass("jqmClose"), a("a.ui-jqdialog-titlebar-close", "#" + a.jgrid.jqID(B.themodal)).unbind("click").click(function () {
            ...
            return d = a.extend(!0, {
                ...
                if (l.grid && c) {
                    var
                        m = l.p.id, n = "ViewGrid_" + a.jgrid.jqID(m), o = "ViewTbl_" + a.jgrid.jqID(m), p = "ViewGrid_" + m, q = "ViewTbl_" + m, r = {
                            themodal: "viewmod" + m,
                            modalhead: "viewhd" + m,
            ...
            return d = a.extend(!0, {
                ...
                if (e.grid && c) {
                    var
                        f, i, j, k, l = a.isFunction(b[e.p.id].beforeShowForm), m = a.isFunction(b[e.p.id].afterShowForm), n = a.isFunction(b[e.p.id].beforeInitData) ? b[e.p.id].beforeInitData : !1, o = e.p.id, p = {}, q = !0, r = "DelTbl_" + a.jgrid.jqID(o), s = "DelTbl_" + o, t = {
                            themodal: "delmod" + o,
                            modalhead: "delhd" + o,
                                ...
                                var
                                    m = a.extend({
                                        ...
                                        complete: function (c, i) {
                                            var
                                                j;
                                            if (a("#dData", "#" + r + "_2").removeClass(h.active), c.status >= 300 && 304 !== c.status ? (g[0] = !1, a.isFunction(b[e.p.id].errorTextFormat) ? g[1] = b[e.p.id].errorTextFormat.call(e, c) : g[1] = i + " Status: '" + c.statusText + "'. Error code: " + c.status) : a.isFunction(b[e.p.id].afterSubmit) && (g = b[e.p.id].afterSubmit.call(e, c, f)), g[0] === !1)a("#DelError>td", "#" + r).html(g[1]), a("#DelError", "#" + r).show(); else {
                ...
                if (this.p.initFilter = a.extend(!0, {}, this.p.filter), d) {
                    ...
                    this.onchange = function () {
                        ...
                        if (this.p.groupButton && (p = a("<input type='button' value='+ {}' title='Add subgroup' class='add-group " + j.button + "'/>"), p.bind("click", function () {
                            ...
                            var
                                q, r = a("<input type='button' value='+' title='Add rule' class='add-rule ui-add " + j.button + "'/>");
                        ...
                        if (null !== c) {
                            var
                                s = a("<input type='button' value='-' title='Delete group' class='delete-group " + j.button + "'/>");
                        ...
                        if (void
                                0 !== b.rules)for (d = 0; d < b.rules.length; d++)if (g.append(this.createTableRowForRule(b.rules[d], b)), w)for (var
                                                                                                                                                      y = b.rules[d].field, x = 0; x < f.p.columns.length; x++)if (y === f.p.columns[x].name) {
                        ...
                        r.append(t), t.bind("change", function () {
                            ...
                            if (l) {
                                ...
                                a(".data", k).append(g), a.jgrid.bindEv.call(o, g, l.searchoptions), a(".input-elm", k).bind("change", function (c) {
                                    var
                                        d = c.target;
                        ...
                        if (p.append(D), this.p.ruleButtons === !0) {
                            var
                                E = a("<input type='button' value='-' title='Delete rule' class='delete-rule ui-del " + j.button + "'/>");
                        ...
                        b(c) {
                            var
                                d, e = "(";
                            if (void
                                    0 !== c.groups)for (d = 0; d < c.groups.length; d++)e.length > 1 && (e += "OR" === c.groupOp ? " || " : " && "), e += b(c.groups[d]);
                            if (void
                                    0 !== c.rules)for (d = 0; d < c.rules.length; d++)e.length > 1 && (e += "OR" === c.groupOp ? " || " : " && "), e += a(c.rules[d]);
                            return e += ")", "()" === e ? "" : e
                        }
                    ...
                    var
                        e, f, g, h = a.jgrid.styleUI[d.p.styleUI || "jQueryUI"].filter, i = a.jgrid.styleUI[d.p.styleUI || "jQueryUI"].common, j = a.jgrid.styleUI[d.p.styleUI || "jQueryUI"].base, k = function () {
                            ...
                            if (b.stringResult === !0 || "local" === d.p.datatype || b.searchOperators === !0) {
                                ...
                                var
                                    q, r, s, t, u, v, w;
                                if (k && (q = a.jgrid.parse(o), q.rules && q.rules.length))for (r = q.rules, s = 0; s < r.length; s++)u = r[s], a.inArray(u.filed, l) && (v = u.data.split(b.splitSelect), v.length > 1 && (void
                                ...
                                if (m && (a.isPlainObject(q) || (q = a.jgrid.parse(o)), q.rules && q.rules.length))for (r = q.rules, s = 0; s < r.length; s++)u = r[s], "bt" === u.op && (v = u.data.split("..."), v.length > 1 && (void
                                    0 === q.groups && (q.groups = []), w = {
                                    groupOp: "AND",
                                    groups: [],
                                    rules: []
            ...
            return b = a.extend(!0, {
                ...
                if (d.grid) {
                    ...
                    if (b.styleUI = d.p.styleUI, "string" == typeof
                            ...
                            0 !== a("#" + a.jgrid.jqID(i.themodal))[0])c(a("#fbox_" + a.jgrid.jqID(d.p.id))); else {
                        var
                        ...
                        w = !1, b.tmplNames && b.tmplNames.length && (w = !0, v = "<tr><td class='ui-search-label'>" + b.tmplLabel + "</td>", v += "<td><select class='ui-template " + k.srSelect + "'>", v += "<option value='default'>Default</option>", a.each(b.tmplNames, function (a, b) {
                            ...
                            0 === b.stringResult && (b.stringResult = b.multipleSearch), a("#" + f + "_search").bind("click", function () {
                            var
                                c, g, j = {};
                            ...
                            return d.p.search = !0, a.extend(d.p.postData, j), h = a(d).triggerHandler("jqGridFilterSearch"), void
                                0 === h && (h = !0), h && a.isFunction(b.onSearch) && (h = b.onSearch.call(d, d.p.filters)), h !== !1 && a(d).trigger("reloadGrid", [{page: 1}]), b.closeAfterSearch && a.jgrid.hideModal("#" + a.jgrid.jqID(i.themodal), {
                            ...
                            return d.p.search = !1, d.p.resetsearch = !0, b.multipleSearch === !1 ? c[b.sField] = c[b.sValue] = c[b.sOper] = "" : c[b.sFilter] = "", e[0].resetFilter(), w && a(".ui-template", m).val("default"), a.extend(d.p.postData, c), h = a(d).triggerHandler("jqGridFilterReset"), void
                                0 === h && (h = !0), h && a.isFunction(b.onReset) && (h = b.onReset.call(d)), h !== !1 && a(d).trigger("reloadGrid", [{page: 1}]), b.closeAfterReset && a.jgrid.hideModal("#" + a.jgrid.jqID(i.themodal), {
                                gb: "#gbox_" + a.jgrid.jqID(d.p.id),
                                jqm: b.jqModal,
                                onClose: b.onClose
                            }), !1
        ...
        editRow: function (b, c, d, e, f, g, h, i, j) {
            ...
            return "object" === a.type(l[0]) ? k = l[0] : (void
                ...
                if (i.grid && (f = a(i).jqGrid("getInd", b, !0), f !== !1)) {
                    if (i.p.beforeAction = !0, h = a.isFunction(k.beforeEditRow) ? k.beforeEditRow.call(i, k, b) : void
                            0, void
                            0 === h && (h = !0), !h)return void(i.p.beforeAction = !1);
                    e = a(f).attr("editable") || "0", "0" !== e || a(f).hasClass("not-editable-row") || (g = i.p.colModel, a('td[role="gridcell"]', f).each(function (e) {
                        ...
                        if (f)d = a("span:first", this).html(); else
                            try {
            ...
            if (void
                ...
                if (m = a(p).attr("editable"), j.url = j.url || k.p.editurl, "1" === m) {
                    ...
                    if (a('td[role="gridcell"]', p).each(function (b) {
                        ...
                        try {
                            var
                                A = a(k).jqGrid("getGridRowById", b), B = a.jgrid.findPos(A);
                    ...
                    var
                        D, E = k.p.prmNames, F = b;
                    if (D = k.p.keyName === !1 ? E.id : k.p.keyName, r) {
                        if (r[E.oper] = E.editoper, void
                                0 === r[D] || "" === r[D])r[D] = b; else if (p.id !== k.p.idPrefix + r[D]) {
                            var
                                G = a.jgrid.stripPref(k.p.idPrefix, b);
                            if (void
                                    0 !== k.p._index[G] && (k.p._index[r[D]] = k.p._index[G], delete
                                    k.p._index[G]), b = k.p.idPrefix + r[D], a(p).attr("id", b), k.p.selrow === F && (k.p.selrow = b), a.isArray(k.p.selarrrow)) {
                                var
                                    H = a.inArray(F, k.p.selarrrow);
            ...
            return c = a.extend(!0, {
                ...
                if (this.grid && !this.p.inlineNav) {
                    ...
                    }), a("#" + f + "_ilcancel").addClass(g)), (c.restoreAfterSelect === !0 || c.saveAfterSelect === !0) && a(d).bind("jqGridBeforeSelectRow.inlineNav", function (b, e) {
                    ...
                    if (h = i.p.colModel[c], e = h.name, "subgrid" !== e && "cb" !== e && "rn" !== e) {
                        if (g = a("td:eq(" + c + ")", i.rows[b]), h.editable !== !0 || d !== !0 || g.hasClass("not-editable-cell") || a.isFunction(i.p.isCellEditable) && !i.p.isCellEditable.call(i, e, b, c))parseInt(i.p.iCol, 10) >= 0 && parseInt(i.p.iRow, 10) >= 0 && a(i.rows[i.p.iRow]).removeClass("selected-row " + k).find("td:eq(" + i.p.iCol + ")").removeClass("edit-cell " + j), g.addClass("edit-cell " + j), a(i.rows[b]).addClass("selected-row " + k), f = g.html().replace(/\&#160\;/gi, ""), a(i).triggerHandler("jqGridSelectCell", [i.rows[b].id, e, f, b, c]), a.isFunction(i.p.onSelectCell) && i.p.onSelectCell.call(i, i.rows[b].id, e, f, b, c); else {
                            ...
                            if (i.p.autoencode && (f = a.jgrid.htmlDecode(f)), h.edittype || (h.edittype = "text"), i.p.savedRow.push({
                                ...
                                var
                                    n = i.p.formatCell.call(i, i.rows[b].id, e, f, b, c);
                                void
                                    0 !== n && (f = n)
                            }
                    ...
                    if (d = e.p.savedRow.length >= 1 ? 0 : null, null !== d) {
                        ...
                        if (i !== e.p.savedRow[d].v) {
                            ...
                            if (u[0] === !0) {
                                ...
                                if (a.isFunction(e.p.beforeSubmitCell) && (w = e.p.beforeSubmitCell.call(e, e.rows[b].id, l, h, b, c), w || (w = {})), a("input.hasDatepicker", j).length > 0 && a("input.hasDatepicker", j).datepicker("hide"), "remote" === e.p.cellsubmit)if (e.p.cellurl) {
                                    var
                                        x = {};
...
!function (a) {
    ...
    a.jgrid.extend({
        setSubGrid: function () {
            return this.each(function () {
                var
                    b, c, d = this, e = a.jgrid.styleUI[d.p.styleUI || "jQueryUI"].subgrid, f = {
                ...
                if (d.grid) {
                    var
                        e, f, g, h, i, j = a.jgrid.styleUI[d.p.styleUI || "jQueryUI"].base, k = a.jgrid.styleUI[d.p.styleUI || "jQueryUI"].common, l = function (b, c, e) {
                            ...
                            if (a(n).append(o), b && (i = d.p.jsonReader.subgrid, f = a.jgrid.getAccessor(b, i.root), void
                                    0 !== f))for (g = 0; g < f.length; g++) {
                                if (h = f[g], o = a("<tr class='" + k.content + " ui-subtblcell'></tr>"), i.repeatitems === !0)for (i.cell && (h = h[i.cell]), m = 0; m < h.length; m++)l(o, h[m] || "&#160;", m); else {
                                    var
                    ...
                    for (void
                        ...
                        if (a(d.rows[s]).hasClass("jqgrow")) {
                            if (d.p.scroll && a(d.rows[s].cells[b]).unbind("click"), q = null, t)var
                                q = d.p.isHasSubGrid.call(d, d.rows[s].id);
                            q === !1 ? d.rows[s].cells[b].innerHTML = "" : a(d.rows[s].cells[b]).bind("click", function () {
                                var
        ...
        groupingSetup: function () {
            return this.each(function () {
                ...
                if (null === g || "object" != typeof
                        g && !a.isFunction(g))e.p.grouping = !1; else if (g.plusicon || (g.plusicon = h.icon_plus), g.minusicon || (g.minusicon = h.icon_minus), g.groupField.length) {
                    for (void
            ...
            return this.each(function () {
                ...
                if (n.hasClass(j)) {
                    if (m)for (; m && (g = o(m.className), !(void
                        0 !== g && f >= g));)a(m).hide(), m = m.nextSibling, r && (a(t).hide(), t = t.nextSibling);
        ...
        setTreeNode: function (b, c) {
            ...
            return this.each(function () {
                ...
                if (f.p.treeGrid) {
                    ...
                    for (d
                        in
                        f.p.colModel)if (f.p.colModel.hasOwnProperty(d)) {
            ...
            return this.each(function () {
                ...
                if (d.grid && d.p.treeGrid)switch (d.p.treeGridModel) {
                    ...
                    case"adjacency":
                        for (var
                                 k = d.p.treeReader.parent_id_field, l = d.p.localReader.id, m = b[l], n = d.p._index[m]; n--;)if (d.p.data[n][l] === a.jgrid.stripPref(d.p.idPrefix, b[k])) {
                            c = d.p.data[n];
                            break
                        }
                }
            ...
            return this.each(function () {
                ...
                if (c === !0)a("div.treeclick", f).removeClass(this.p.treeIcons.minus + " tree-minus " + this.p.treeIcons.plus + " tree-plus").addClass(this.p.treeIcons.leaf + " tree-leaf"); else if (c === !1) {
                    var
            ...
            return this.each(function () {
                if (this.grid && this.p.treeGrid) {
                    ...
                    a(this).jqGrid("delChildren", b[d]), void
                        0 === c && (c = !1), c || jQuery._data(this, "events").jqGridAfterSetTreeNode || a(this).bind("jqGridAfterSetTreeNode.reloadNode", function () {
                        var
            ...
            return this.each(function () {
                if (this.grid && this.p.treeGrid && i)for (c = this.p.localReader.id; i--;)if (j = a(this).jqGrid("getNodeAncestors", b[i], !0, !0), j.push(b[i]), d = j[0][c], -1 === a.inArray(d, k))k.push(d), l = l.concat(j); else
                    for (g = 0, e = j.length; e > g; g++) {
                        var
                            m = !1;
                        for (h = 0, f = l.length; f > h; h++)if (j[g][c] === l[h][c]) {
                            m = !0;
                            break
                        }
                        m || l.push(j[g])
                ...
                if (h.grid && h.p.treeGrid) {
                    ...
                    if (void
                        ...
                        if ("nested" === h.p.treeGridModel) {
                            if (f = a.jgrid.from.call(h, h.p.data).greater(j, d, {stype: "integer"}).select(), f.length)for (g
                                in
                                f)f.hasOwnProperty(g) && (f[g][j] = parseInt(f[g][j], 10) - e);
                            if (f = a.jgrid.from.call(h, h.p.data).greater(k, d, {stype: "integer"}).select(), f.length)for (g
                                in
                ...
                if (g.grid && g.p.treeGrid) {
                    ...
                    if (void
                        ...
                        if ("nested" === g.p.treeGridModel) {
                            if (e = a.jgrid.from(g.p.data).greater(i, c, {stype: "integer"}).select(), e.length)for (f
                                in
                                e)e.hasOwnProperty(f) && (e[f][i] = parseInt(e[f][i], 10) - d);
                            if (e = a.jgrid.from(g.p.data).greater(j, c, {stype: "integer"}).select(), e.length)for (f
                                in
            ...
            if (d) {
                ...
                if (m = !1, void
                        0 === c || null === c || "" === c)c = null, w = null, g = "last", j = f.p.tree_root_level, k = f.p.data.length + 1; else {
                ...
                if (l = k + 1, void
                    ...
                    var
                        z, A, B;
                    if (null !== c) {
                        if (n = parseInt(i[t], 10), z = a.jgrid.from.call(f, f.p.data), z = z.greaterOrEquals(t, n, {stype: "integer"}), A = z.select(), A.length)for (B
                            in
                            A)A.hasOwnProperty(B) && (A[B][s] = A[B][s] > n ? parseInt(A[B][s], 10) + 2 : A[B][s], A[B][t] = A[B][t] >= n ? parseInt(A[B][t], 10) + 2 : A[B][t]);
                        d[s] = n, d[t] = n + 1
                    } else {
                        if (n = parseInt(a(f).jqGrid("getCol", t, !1, "max"), 10), A = a.jgrid.from.call(f, f.p.data).greater(s, n, {stype: "integer"}).select(), A.length)for (B
                            in
                            A)A.hasOwnProperty(B) && (A[B][s] = parseInt(A[B][s], 10) + 2);
                        if (A = a.jgrid.from.call(f, f.p.data).greater(t, n, {stype: "integer"}).select(), A.length)for (B
                            in
...
!function (a) {
    ...
    b(a, b) {
        ...
        if (!this || "function" != typeof
                a || a instanceof RegExp)throw new
            TypeError;
        ...
        pivotSetup: function (c, d) {
            ...
            return this.each(function () {
                ...
                o(b, c, d, e) {
                    ...
                    for (a.isArray(d) ? (k = d.length, o = d) : (k = 1, o[0] = d), h = [], i = [], h.root = 0, e._count ? e._count++ : e._count = 1, j = 0; k > j; j++) {
                        ...
                        for (f = 0; l > f; f++) {
                            ...
                            g = isNaN(parseInt(g, 10)) ? g : g + " ", e[g] = q[g] = n(c[f].aggregator, e[g], c[f].member, b, e._count)
                        }
                ...
                p(a) {
                    ...
                    for (d
                        in
                        a)if (a.hasOwnProperty(d)) {
                        if ("object" != typeof
                                a[d]) {
                            if ("level" === d) {
                                if (void
                                        0 === L[a.level] && (L[a.level] = "", a.level > 0 && -1 === a.text.indexOf("_r_Totals") && (k[a.level - 1] = {
                                        useColSpanStyle: !1,
                                        groupHeaders: []
                                    ...
                                    var
                                        h = k[a.level - 1].groupHeaders.length - 1, i = 0 === h ? N : M;
                        ...
                        if (null != a[d] && "object" == typeof
                                a[d] && p(a[d]), "level" === d && a.level > 0 && (a.level === (0 === u ? a.level : u) || -1 !== L[a.level].indexOf("_r_Totals"))) {
                            c = 0;
                            for (b
                                in
                                a.fields)if (a.fields.hasOwnProperty(b)) {
                                g = {};
                                for (f
                                    in
                                    l.aggregates[c])if (l.aggregates[c].hasOwnProperty(f))switch (f) {
                                    case"member":
                                    case"label":
                                    case"aggregator":
                                        break;
                ...
                for (var
                    ...
                    w = {}, s = 0;
                    do
                        E[s] = a.trim(q[l.xDimension[s].dataName]), w[l.xDimension[s].dataName] = E[s], s++; while (t > s);
                    var
                        G = 0;
                    if (r = -1, x = d(f, m, E)) {
                        if (r >= 0) {
                    ...
                    for (H
                        in
                        h)if (h.hasOwnProperty(H)) {
                        if (0 === I)D.children && void
                            0 !== D.children || (D = {
                            text: H,
                            level: 0,
                            children: [],
                ...
                if (l.colTotals)for (var
                                         P = f.length; P--;)for (s = t; s < e.length; s++)O = e[s].name, g[O] ? g[O] += parseFloat(f[P][O] || 0) : g[O] = parseFloat(f[P][O] || 0);
                if (C > 0)for (s = 0; C > s; s++)e[s].isGroupField && (j.groupingView.groupField.push(e[s].name), j.groupingView.groupSummary.push(l.groupSummary), j.groupingView.groupSummaryPos.push(l.groupSummaryPos)); else
                    j.grouping = !1;
        ...
        saveState: function (b, c) {
            if (c = a.extend({
                ...
                var
                    d, e, f = "", g = "", h = a("#" + b)[0];
                if (h.grid) {
                    e = a(h).data("inlineNav"), e && h.p.inlineNav && a(h).jqGrid("setGridParam", {_iN: e}), e = a(h).data("filterToolbar"), e && h.p.filterToolbar && a(h).jqGrid("setGridParam", {_fT: e}), f = a(h).jqGrid("jqGridExport", {
                        exptype: "jsonstring",
                        ident: "",
                        root: ""
                    ...
                    if (g = g.slice(i + 5), a.isFunction(c.beforeSetItem) && (d = c.beforeSetItem.call(h, f), null != d && (f = d)), c.debug) {
                        ...
                        k = URL.createObjectURL(j), a("#link_save").attr("href", k).bind("click", function () {
                            a(this).remove()
                        })
                    }
            ...
            if (d = a.extend({
                ...
                if (c) {
                    ...
                    if (e = jqGridUtils.parse(c), e && "object" === a.type(e)) {
                        ...
                        var
                            n = a("#" + b).jqGrid(e);
                        if (n.append(g), n.jqGrid("setGridParam", m), e.storeNavOptions && e.navGrid && (n[0].p.navGrid = !1, n.jqGrid("navGrid", e.pager, e.navOptions, e.editOptions, e.addOptions, e.delOptions, e.searchOptions, e.viewOptions), e.navButtons && e.navButtons.length))for (var
                        ...
                        if (e.treeGrid)for (var
                                                r = 1, s = n[0].rows.length, t = e.expColInd, u = e.treeReader.leaf_field, v = e.treeReader.expanded_field; s > r;)a(n[0].rows[r].cells[t]).find("div.treeclick").bind("click", function (b) {
                            var
                        ...
                        }), e.ExpandColClick === !0 && a(n[0].rows[r].cells[t]).find("span.cell-wrapper").css("cursor", "pointer").bind("click", function (b) {
                            var
                                c = b.target || b.srcElement, d = a.jgrid.stripPref(e.idPrefix, a(c, n[0].rows).closest("tr.jqgrow")[0].id), f = n[0].p._index[d];
                ...
                var
                    addNode = function (hash, key, cnts, val) {
                        ...
                        if (7 !== a.nodeType) {
                            ...
                            var
                                c, d, e, f, g = {};
                            if (a.attributes && a.attributes.length)for (c = {}, d = 0; d < a.attributes.length; d++)e = a.attributes[d].nodeName, "string" == typeof
                            ...
                            if (a.childNodes && a.childNodes.length) {
                                ...
                                if (h)for (c || (c = ""), d = 0; d < a.childNodes.length; d++)c += a.childNodes[d].nodeValue; else
                            ...
                            drop: function (a) {
                                return $.extend({
                                    accept: function (a) {
                                        ...
                                        var
                                            b = $(a).closest("table.ui-jqgrid-btable");
                                        if (b.length > 0 && void
                                                0 !== $.data(b[0], "dnd")) {
                                            var
                                                c = $.data(b[0], "dnd").connectWith;
                                        ...
                                        if ($(c.draggable).hasClass("jqgrow")) {
                                            var
                                                d = $(c.draggable).attr("id"), f = c.draggable.parent().parent().jqGrid("getRowData", d);
                                            if (!a.dropbyname) {
                                                var
                                                    g, h, i = 0, j = {}, k = $("#" + $.jgrid.jqID(this.id)).jqGrid("getGridParam", "colModel");
                                                try {
                                                    for (h
                                                        in
                                                        f)f.hasOwnProperty(h) && (g = k[i].name, "cb" !== g && "rn" !== g && "subgrid" !== g && f.hasOwnProperty(h) && k[i] && (j[g] = f[h]), i++);
                                                    f = j
                                                } catch (l) {
                                                }
                                            }
                                            if (c.helper.dropped = !0, a.beforedrop && $.isFunction(a.beforedrop)) {
                                                var
                                                    m = a.beforedrop.call(this, b, c, f, $("#" + $.jgrid.jqID(e.p.id)), $(this));
                                                void
